...
import 'package:mum_k4/screens/user/admin/report/Monthly_Report/MonthlyAahnikReport.dart';
...
import 'package:mum_k4/screens/user/admin/Aaahnik.dart';
                ...
                ButtonTheme(
                  ...
                  child: FlatButton.icon(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                          context, SlideRightRoute(page: Aaahnik()));
                    },
                  ),
                ),
                ButtonTheme(
                  ...
                  child: FlatButton.icon(
                    ...
                    label: Text("Today's Aahnik Report"),
                    onPressed: () {
                      Navigator.push(context,
                          SlideRightRoute(page: DailyAahnikReport()));
                    },
                  ),
                ),
                ButtonTheme(
                  ...
                  child: FlatButton.icon(
                    ...
                    onPressed: () {
                      Navigator.push(context,
                          SlideRightRoute(page: MonthlyAahnikReport()));
                    },
                  ),
                ),
                ButtonTheme(
